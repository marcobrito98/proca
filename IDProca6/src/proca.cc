   ...
   CCTK_VInfo(CCTK_THORNSTRING,"Finishing reading file");
		...
		/*	betak = - 2.0 * mass * a * r_BL / A; */
            ...
            av2lz[i3D] = av2lk;*/
                ...
                sv2         = - (Vproca_aux)/alp_aux*(1.0 + fac*cos(modepert*phi));
                av1li       = + H1_aux/R*(1.0 + fac*cos(modepert*phi)); 
                av1lj       = + H2_aux*(1.0 + fac*cos(modepert*phi));
                Efield2li   = + H1_aux/R*(1.0 + fac*cos(modepert*phi));
                Efield2lj   = + H2_aux*(1.0 + fac*cos(modepert*phi));
            }
